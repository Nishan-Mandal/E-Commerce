...
function DashboardTab() {
    ...
    const { mode, product, edithandle, deleteProduct, order, user, getUserData } = context
                                ...
                                {order.map((allorder, index) => {
                                    return (
                                        <table key={index} className="w-full text-sm text-left text-gray-500 dark:text-gray-400" >
                                            ...
                                            {allorder.items.map((item, index) => {
                                                const {title,description,category,imageUrl,price, date} = item;
                                                return (
                                                    <tbody key={index}>
                                                        <tr className="bg-gray-50 border-b  dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                                            <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
