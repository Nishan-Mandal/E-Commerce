...
export default function Navbar() {
  ...
  const { toggleMode, mode, userName } = context
            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  {user?.user?.email === 'nishanmandal667@gmail.com' ? <div className="flow-root">
                  ...
                  {/* <div className="flow-root">
                    <Link to={'/'} className="-m-2 block p-2 font-medium text-gray-900 cursor-pointer">
                      <img
                        ...
                        src="https://images.unsplash.com/photo-1704409040950-1d50e398e64b?q=80&w=2787&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
                ...
                <div className="-m-2 flex items-center p-2">
                    <CgProfile style={{ fontSize: '2em', strokeWidth: '0.5' }} />
                    <h6 className="ml-2">{userName}</h6>
                  </div>
                  <a href="#" className="-m-2 flex items-center p-2">
                    ...
                    /> */}
                    <span className="ml-1 block text-base font-medium text-gray-900" style={{ color: mode === 'dark' ? 'white' : '', }}>Email: {user?.user?.email}</span>
                  </a>
                </div>
              </Dialog.Panel>
            </Transition.Child>
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className='flex'>
                  <div className="flex ">
                    <h1 className=' text-3xl font-bold text-black  px-2 py-1 rounded' style={{ color: mode === 'dark' ? 'white' : '', fontFamily: 'Pirou'}}>Drawt</h1>
                  </div>
                </Link>
              </div>
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  {user?.user?.email === 'nishanmandal667@gmail.com' ?
